...
class AttackLM():
    ...
    def get_attack(self, convs_list, prompts_list):
        ...
        # Original PAIR has no improvement history on the first attack.
        is_first_turn = all(len(conv.messages) == 0 for conv in convs_list)
        ...
        if is_first_turn:
            for index, attack in enumerate(valid_outputs):
                attack["improvement"] = ""
                new_adv_prompts[index] = json.dumps(attack)
