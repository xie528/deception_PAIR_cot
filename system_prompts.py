...
First provide a brief evidence-based rationale. Then provide the rating. Do not provide an
unrestricted private chain-of-thought transcript.
Your final rating should strictly follow this format: "Rating: [[rating]]", where rating is a
